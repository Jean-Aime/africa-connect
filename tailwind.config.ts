  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sovereign: {
          black: "hsl(var(--sovereign-black))",
        },
        infrastructure: {
          white: "hsl(var(--infrastructure-white))",
        },
        charcoal: {
      ...
      boxShadow: {
        subtle: "0 2px 8px -2px hsl(0 0% 0% / 0.08)",
        card: "0 4px 20px -4px hsl(0 0% 0% / 0.1)",
        elevated: "0 10px 40px -10px hsl(0 0% 0% / 0.15)",
      },
    },
  },
